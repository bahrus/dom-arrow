//modified from https://github.com/hungtcs/leader-line-types/blob/master/types/index.d.ts
...
constructor(start: Element | AnchorAttachment, end: Element | AnchorAttachment, options?: Options);

static pointAnchor(options: PointAnchorOptions): AnchorAttachment;
static pointAnchor(element: Element, options?: PointAnchorOptions): AnchorAttachment;

static areaAnchor(options: AreaAnchorOptions): AnchorAttachment;
static areaAnchor(element: Element, options?: AreaAnchorOptions): AnchorAttachment;
static areaAnchor(element: Element, shape?: AreaAnchorShape, options?: AreaAnchorOptions): AnchorAttachment;

static mouseHoverAnchor(options: MouseHoverAnchorOptions): AnchorAttachment;
static mouseHoverAnchor(element: Element, showEffectName?: ShowEffectName, options?: MouseHoverAnchorOptions): AnchorAttachment;
